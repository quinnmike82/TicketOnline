...
namespace TicketOnline.Migrations
{
    ...
    [Migration("20230317065636_updateMovie")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TicketOnline.Model.Genre", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("TicketOnline.Data.Movie", b =>
                {
                    b.HasOne("TicketOnline.Model.Genre", "Genre")
                        .WithMany()
            ...
            modelBuilder.Entity("TicketOnline.Data.Seat", b =>
                {
                    ...
                    b.HasOne("TicketOnline.Data.ShowTime", null)
                        .WithMany("Seats")
            ...
            modelBuilder.Entity("TicketOnline.Data.Ticket", b =>
                {
                    ...
                    b.HasOne("TicketOnline.Data.ShowTime", "ShowTime")
                        .WithMany()
                        .HasForeignKey("ShowtimeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
